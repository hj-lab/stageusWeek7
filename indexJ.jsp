...
<body>
    ...
    <div id="boxParent">
        <input type="button" id="box1" class="commentBox" value="Sign In" onclick="location.href='login.html'">
        <input type="button" id="box2" class="commentBox" value="Yours" onclick="location.href='myInformationJ.jsp'">
        <input type="button" id="box3" class="commentBox" value="Board" onclick="location.href='messageBoard.html'">
    </div>
