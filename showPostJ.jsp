...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="showPostC.css">
    ...
    <div id="showPostParent">
        <div id="post">
            ...
            <div id="postInform">
                ...
                <div id="postDate"></div>
                <div id="rightBtn">
                    <input type="button" value="수정" id="transformBtn" onclick="location.href='modifyPost.html'">
                    <input type="button" value="삭제" id="transformBtn" onclick="location.href='delPost.html'">
                </div>
            </div>
    ...
    <script>
        ...
        for(var i=0; i<commentNumList.length; i++){
            ...
            modifyBtn.onclick = function(){
                location.href = 'modifyComment.html'
            }
