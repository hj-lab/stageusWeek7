...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="myInformationC.css">
</head>
<body>
    <div>
    ...
    <div id="informationParent">
        ...
        <div id="myinformationMore">
            <input type="button" class="myinformationMoreBtn" value="정보 수정하기" onclick="location.href='modifyMyInfo.html'">
            <input type="button" class="myinformationMoreBtn" value="회원 탈퇴" onclick="location.href='quit.html'">
        </div>
